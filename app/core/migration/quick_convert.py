...
def convert(text:str,source_vendor:str,source_version:str,target_vendor:str="paloalto",target_version:str="11.1",management_mode:str="LOCAL_FIREWALL")->QuickConvertResult:
    ...
    header=["# Convert-In","# CANDIDATE CONFIGURATION — ENGINEER REVIEW REQUIRED","#",f"# Source Vendor: {'Cisco ASA' if vendor==Vendor.ASA else 'FortiGate'}",f"# Source Version: {selected}","# Target Vendor: Palo Alto Networks","# Target Version: PAN-OS 11.1","# Management Mode: LOCAL_FIREWALL","#","# Generated locally.","# No deployment performed.","#","# Conversion Summary",f"# Generated: {summary['generated']}",f"# Manual Review: {summary['manual_review']}",f"# Unsupported: {summary['unsupported']}",f"# Version Not Verified: {summary['version_not_verified']}","#"]
    ...
    return QuickConvertResult(vendor,selected,lines,summary,categories,warnings)